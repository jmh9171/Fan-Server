...
class MyTCPHandler(http.server.SimpleHTTPRequestHandler):
    ...
    def accLog(self,msg):
        ...
        with open('Log.txt','a') as log:
            ...
            log.write( 'Accessed: {} By: {} to {}\n'.format(localtime,self.address_string(),msg))
    ...
    def do_GET(self):
        ...
        #else if the request is for the Json data
        elif self.path.lower() == '/data.json':
        ...
        #else just return the html page 
...
class MyTCPServer(socketserver.TCPServer):
    ...
    def server_activate(self):
        ...
        with open('data.json', 'w') as outfile:
            ...
            #write the default setting to the json data file
